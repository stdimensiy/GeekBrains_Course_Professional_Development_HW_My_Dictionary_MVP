 ...
 *
 * Планируется реализация в цепочках RX для выполнения конкретных задач
 * в конкретных потоках (включает все используемые в рамках курса при выполнении ДЗ методы)
 */
